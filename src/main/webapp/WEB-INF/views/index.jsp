...
<body>
	...
	<div class="homeBanner" style="background-image: url(images/banner.jpg);">
		<div class="container text-center text-white">
			<div class="row justify-content-center">
				<div class="col-md-10">
					<h1 class="text-white">Lorem ipsum dolor sit amet.</h1>
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam sed rutrum lorem, non eleifend nisi. Nunc ut convallis nibh, et convallis ex. Donec cursus posuere lacus, sit amet pretium lectus ornare nec. In ac ligula eget lorem auctor volutpat.</p>
				</div>
		...
		<div class="container">
			<div class="text-center">
				<div class="displayInlineBanner">
					<h2 class="RockSalt text-right text-white">Just looking around? Let us suggest you <br />something hot & happening!  </h2>
				</div>
	...
	<div class="section3" style="background-image: url(images/section3.png);">
		<div class="container text-center text-white">
			...
			<h3 class="text-white RockSalt">Read Stories</h3>
