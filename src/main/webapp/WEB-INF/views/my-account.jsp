					...
					<div class="sidebar left">
						...
						<div class="my-account-nav-container">
							...
							<ul class="my-account-nav">
								...
								<li><a href="my-account" class="current"><i class="ti-user"></i> My Profile</a></li>
								<li><a href="my-earnings" class=""><i class="ti-money"></i> Earnings</a></li> 
								<li><a href="my-report" class=""><i class="ti-pie-chart"></i> Report</a></li>
								<li><a href="mail" class=""><i class="ti-email"></i> Messages</a></li> 
							</ul>
